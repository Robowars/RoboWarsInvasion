...
public class EntityLaser  extends Entity implements IProjectile {
    ...
    DamageSource source = new DamageSource(this.toString());
    ...
    public void setThrowableHeading(double p_setThrowableHeading_1_, double p_setThrowableHeading_3_, double p_setThrowableHeading_5_, float p_setThrowableHeading_7_, float p_setThrowableHeading_8_) {
        float var9 = MathHelper.sqrt_double(p_setThrowableHeading_1_ * p_setThrowableHeading_1_ + p_setThrowableHeading_3_ * p_setThrowableHeading_3_ + p_setThrowableHeading_5_ * p_setThrowableHeading_5_);
        p_setThrowableHeading_1_ /= (double)var9;
        p_setThrowableHeading_3_ /= (double)var9;
        p_setThrowableHeading_5_ /= (double)var9;
        p_setThrowableHeading_1_ += this.rand.nextGaussian() * (double)(this.rand.nextBoolean()?-1:1) * 0.007499999832361937D * (double)p_setThrowableHeading_8_;
        p_setThrowableHeading_3_ += this.rand.nextGaussian() * (double)(this.rand.nextBoolean()?-1:1) * 0.007499999832361937D * (double)p_setThrowableHeading_8_;
        p_setThrowableHeading_5_ += this.rand.nextGaussian() * (double)(this.rand.nextBoolean()?-1:1) * 0.007499999832361937D * (double)p_setThrowableHeading_8_;
        p_setThrowableHeading_1_ *= (double)p_setThrowableHeading_7_;
        p_setThrowableHeading_3_ *= (double)p_setThrowableHeading_7_;
        p_setThrowableHeading_5_ *= (double)p_setThrowableHeading_7_;
        this.motionX = p_setThrowableHeading_1_;
        this.motionY = p_setThrowableHeading_3_;
        this.motionZ = p_setThrowableHeading_5_;
        float var10 = MathHelper.sqrt_double(p_setThrowableHeading_1_ * p_setThrowableHeading_1_ + p_setThrowableHeading_5_ * p_setThrowableHeading_5_);
        ...
        this.prevRotationPitch = this.rotationPitch = (float)(Math.atan2(p_setThrowableHeading_3_, (double)var10) * 180.0D / 3.1415927410125732D);
    ...
    public void setPositionAndRotation2(double p_setPositionAndRotation2_1_, double p_setPositionAndRotation2_3_, double p_setPositionAndRotation2_5_, float p_setPositionAndRotation2_7_, float p_setPositionAndRotation2_8_, int p_setPositionAndRotation2_9_) {
        this.setPosition(p_setPositionAndRotation2_1_, p_setPositionAndRotation2_3_, p_setPositionAndRotation2_5_);
        this.setRotation(p_setPositionAndRotation2_7_, p_setPositionAndRotation2_8_);
    }
    ...
    public void setVelocity(double p_setVelocity_1_, double p_setVelocity_3_, double p_setVelocity_5_) {
        ...
        if(this.prevRotationPitch == 0.0F && this.prevRotationYaw == 0.0F) {
            float var7 = MathHelper.sqrt_double(p_setVelocity_1_ * p_setVelocity_1_ + p_setVelocity_5_ * p_setVelocity_5_);
            this.prevRotationYaw = this.rotationYaw = (float)(Math.atan2(p_setVelocity_1_, p_setVelocity_5_) * 180.0D / 3.1415927410125732D);
            this.prevRotationPitch = this.rotationPitch = (float)(Math.atan2(p_setVelocity_3_, (double)var7) * 180.0D / 3.1415927410125732D);
        ...
        if(this.inGround) {
            ...
            if(var4 != null) {
                if(var4.entityHit != null) {
                    ...
                    if(var4.entityHit.attackEntityFrom(source, (float)var21)) {
    ...
    public void readEntityFromNBT(NBTTagCompound p_readEntityFromNBT_1_) {
        ...
        this.field_145790_g = Block.getBlockById(p_readEntityFromNBT_1_.getByte("inTile") & 255);
    ...
    public void onCollideWithPlayer(EntityPlayer p_onCollideWithPlayer_1_) {
        if(!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0) {
            ...
            if(this.canBePickedUp == 1 && !p_onCollideWithPlayer_1_.inventory.addItemStackToInventory(new ItemStack(Items.arrow, 1))) {
                var2 = false;
            }
